...
no_of_vehicles = 5  # free to modify
no_of_customers = 11
df = pd.read_csv(r'C:\Users\Dell\OneDrive\Desktop\pr2\satellite 9.txt', sep=" ")
...
def plot_tours(solution_x):
    ...
    plt.scatter(df["X"][0], df["Y"][0], marker = "o", color = 'b', label = "Satellite 9")
